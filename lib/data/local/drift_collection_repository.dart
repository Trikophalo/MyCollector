...
class DriftCollectionRepository implements CollectionRepository {
          ...
          case CatalogCard card:
            batch.insert(
              ...
              CardEntriesCompanion.insert(
                ...
                serieId: Value(card.serieId),
                setAbbreviation: Value(card.setAbbreviation),
        ...
        for (final h in positions)
          {
            ...
            'name': catalog[h.catalogId]?.fullLabel,
            'quantity': h.quantity,
  ...
  CatalogCard _toCard(CardEntry row) => CatalogCard(
    ...
    serieId: row.serieId,
    setAbbreviation: row.setAbbreviation,
